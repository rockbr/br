    ...
    <div class="row">
        ...
        <div class="col-lg-12">
            <div class="card mb-4">
                ...
                <div class="card-header"><i class="fas fa-chart-bar mr-1"></i>Pagar e Receber</div>
                <div class="card-body">
                    <div id="chartReportPagarReceberPorMes">
                        <canvas id="chartPagarReceberPorMes" width="100%" height="50"></canvas>
                    </div>
                    <div class="input-group card-title">
                        <div class="input-group-prepend">
                            <div class="input-group-text"><i class="fas fa-calendar-alt"></i></div>
                        </div>
                        <select class="form-control" name="pagar_receber_mes_ano" id="pagar_receber_mes_ano" required>
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="input-group card-title">
                        ...
                        <select class="form-control" name="pagar_mes_ano" id="pagar_mes_ano" required>
                            <option value="" disabled selected>Selecione</option>
                            <?php if (!empty($pagar_mes_ano)) {
                                foreach ($pagar_mes_ano as $frow) { ?>
                                    <option value="<?php echo $frow['mes_ano']; ?>" <?= (isset($dados['mes_ano']) && $dados['mes_ano'] == $frow['mes_ano']) ? ' selected' : '' ?>>
            ...
            <div class="card mb-4">
                ...
                <div id="chartReportReceberPorMes">
                    ...
                    <div class="input-group card-title">
                        ...
                        <select class="form-control" name="receber_mes_ano" id="receber_mes_ano" required>
                            <option value="" disabled selected>Selecione</option>
