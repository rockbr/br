...
class GrupoProduto extends BaseController
{
	protected $tabela = 'grupos_produtos';
	protected $session;
	...
	public function list()
	{
		...
		$data_header = array(
			'titulo' => 'Consulta',
			'subtitulo' => 'CONSULTA GRUPO DE PRODUTOS',
		...
		$data = array(
			...
			'sucesso' => $sucesso,
			'acoes_novo' => 'novogruposprodutos',
			'acoes_editar' => 'editagruposprodutos',
			'acoes_deletar' => 'deletagruposprodutos',
			'pagina' => $pagina,
	...
	public function cadastro($id = null)
	{
		...
		$data = array(
			'titulo' => 'Cadastro Grupos de Produtos',
			'url_salvar' => 'salvagruposprodutos',
			'dados' => $dados,
			'erro' => $erro,			
		);
