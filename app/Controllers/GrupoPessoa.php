...
class GrupoPessoa extends BaseController
{
	protected $tabela = 'grupos_pessoas';
	protected $session;
	...
	public function list()
	{
		...
		$data_header = array(
			'titulo' => 'Consulta',
			'subtitulo' => 'CONSULTA GRUPO DE CLIENTES',
		...
		$data = array(
			...
			'sucesso' => $sucesso,
			'acoes_novo' => 'novogrupospessoas',
			'acoes_editar' => 'editagrupospessoas',
			'acoes_deletar' => 'deletagrupospessoas',
			'pagina' => $pagina,
			...
			'limite' => $limit,
			'url' => site_url('consultagrupospessoas'),
		);
	...
	public function cadastro($id = null)
	{
		...
		$data = array(
			'titulo' => 'Cadastro Grupos de Clientes',
			'url_salvar' => 'salvagrupospessoas',
			'dados' => $dados,
			'erro' => $erro,			
		);
